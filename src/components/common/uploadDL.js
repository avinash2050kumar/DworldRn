...
class UploadDL extends Component {
  ...
  render() {
    const {title, image, description, formikprops, input, url} = this.props;
    ...
    return (
      <Card style={[styles.flex_row]}>
        ...
        <FullScreenImage
          ...
          setModalVisible={() => this.setState({isVisible: false})}
        />
      </Card>
    );
  }
