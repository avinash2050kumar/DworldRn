...
class ProfileScreen extends Component {
  ...
  render() {
    const {FirstName, LastName, Email, Mobile} = this.props.personalDetails;
    return (
      <View
        style={
          {
        ...
        <NavigationBar
          ...
          <TouchableOpacity
            onPress={() => NavigationService.navigate('LogoutScreen')}>
            <StyledTitle
              style={{
                color: theme.primary,
                fontSize: 16,
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <Screen style={{backgroundColor: '#fff'}}>
            ...
            <View style={[styles.flex_row, {justifyContent: 'space-between'}]}>
              <View
                ...
                <View>
                  ...
                  <StyledTitle>{Mobile ? Mobile : ''}</StyledTitle>
                </View>
              </View>
              <TouchableOpacity
                onPress={() => NavigationService.navigate('ProfileFormScreen')}>
            ...
            />
            <FlatList
              data={this.action[this.props.auth.ClientTypeId - 1].data}
