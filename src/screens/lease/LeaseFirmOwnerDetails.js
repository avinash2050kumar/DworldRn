            ...
            <View style={{marginLeft: 5, marginRight: 5}}>
              <Card
                ...
                <View
                  ...
                  <View>
                    ...
                    <StyledPropText>Insantive(Per Month)</StyledPropText>
                  </View>
                  ...
                  <View style={{alignItems: 'flex-end'}}>
                    ...
                    <StyledPropText>{item.Name}</StyledPropText>
              ...
              <Card
                ...
                <View
                  ...
                  <View>
                    <StyledPropText>Vehicle Category</StyledPropText>
                  ...
                  <View style={{alignItems: 'flex-end'}}>
                    ...
                    <StyledPropText>{item.vhicle.Company}</StyledPropText>
                    <StyledPropText>
                      {item.vhicle.VehicleType.Name}
                    </StyledPropText>
                  </View>
              ...
              <Button
                label={
                  this.props.navigation.getParam('buttonTitle')
                    ? this.props.navigation.getParam('buttonTitle')
                    : 'No title'
                }
              />
