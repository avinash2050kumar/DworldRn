    ...
    return (
      <ScrollView>
        <Screen style={{backgroundColor: theme.white}}>
          <View>
            <Text>Enter the work shift you want the driver to drive.</Text>
                    ...
                    <Form>
                      <View>
                        ...
                        <Selector
                          ...
                          defaultValue={props.values.work.ShitType.Name.toString()}
                          placeholder="Shifts"
                          ...
                          onChange={value => {
                            let i = 0;
                            this.props.ShiftType.map((val, index) => {
                              if (val.Name === value) i = index;
                            });
                            props.setFieldValue(
                              `work.ShitType`,
                              this.props.ShiftType[i],
                            );
                          }}
                        />
                      </View>
                      ...
                      {props.values.work.PreferDays != this.getDaysString(props)
                        ? props.setFieldValue(
                            'work.PreferDays',
                            this.getDaysString(props),
                          )
                        : console.log(
                            'Propdfsgafgs',
                            props.values.work.JobType.Name.toString(),
                            props.values,
                          )}
                      <View>
                        ...
                        <Selector
                          ...
                          valueKey="value" // Default: 'value'
                          labelKey="value" // Default: 'label'
                          defaultValue={props.values.work.JobType.Name.toString()}
                          ...
                          onChange={value => {
                            let i = 0;
                            this.props.JobType.map((val, index) => {
                              if (val.Name === value) i = index;
                            });
                            props.setFieldValue(
                              `work.JobType`,
                              this.props.JobType[i],
                            );
                          }}
                        />
                        <Selector
                          theme="dropdown" // Default: 'simple'
                          items={props.values.WorkType.map(shift => {
                            return {
                              ...shift,
                              value: shift.Name,
                            };
                          ...
                          valueKey="value" // Default: 'value'
                          labelKey="value" // Default: 'label'
                          defaultValue={props.values.SelectedWork.Name} // Set default value
                          ...
                          onChange={value => {
                            let i = 0;
                            props.values.WorkType.map((val, index) => {
                              if (val.Name === value) i = index;
                            });
                            props.setFieldValue(
                              'work.PreferDays',
                              props.values.WorkType[i].Name.toString(),
                            );
                            props.setFieldValue(
                              'SelectedWork',
                              props.values.WorkType[i],
                            );
                          }}
                        />
                        {props.values.SelectedWork.Name &&
                          props.values.SelectedWork.Name === 'Custom Days' && (
                            <View>
                              <StyledTitle
