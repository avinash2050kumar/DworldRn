                ...
                <BuyNowButton
                    ...
                    onPress={() => {
                        ...
                        RazorpayCheckout.open(options).then(async (data) => {
                            ...
                            res.status===200 ? this.props.getUserSubscription():console.log('Oh god')
                            res.status===200 ? this.props.navigation.pop():console.log('Oh god')
                        }).catch((error) => {
                            // handle failure
...
const mapStateToProps = state => ({ workSchedules: state.main.workSchedules , ClientId:state.auth.ClientId});
