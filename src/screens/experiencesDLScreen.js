...
class ExperiencesDLScreen extends Component {
  ...
  _Submit = async (values, actions) => {
    ...
    const res = await this.props.saveExperienceAndDl(
      Object.assign({}, values.license, {ClientId}),
    );
    if (res.status === 200) NavigationService.navigate('WorkScheduleScreen');
  };
                  ...
                  <View style={[styles.flex_col_btwn]}>
                    <Form>
                      ...
                      <Selector
                        ...
                        items={
                          this.state.experiences.licenseType
                        ...
                        defaultValue={`${props.values.license.LicenseType.Name}`} // Set default value
                        ...
                        onChange={value => {
                          let i = 0;
                          props.values.licenseType.map((val, index) => {
                            if (val.Name === value) i = index;
                          });
                          props.setFieldValue(
                            `license.LicenseType`,
                            props.values.licenseType[i],
                          );
                        }}
                      />
                      <UploadDL
                        formikprops={props}
                        input={'FrontPage'}
                        _setVisiblity={this._setVisiblity}
                        title={'Driving Licence Front'}
                        url={[
                          Object.assign(
                            {},
                            {
                              uri: props.values.license.FrontPage,
                            },
                          ),
                        ]}
                      ...
                      <UploadDL
                        ...
                        url={[
                          Object.assign(
                            {},
                            {
                              uri: props.values.license.BackPage,
                            },
                          ),
                        ]}
                        description={
                      ...
                      <UploadDL
                        ...
                        url={[
                          Object.assign(
                            {},
                            {
                              uri: props.values.license.OtherProof,
                            },
                          ),
                        ]}
                        description={'Upload  the Other proof'}
                      />
                    </Form>
