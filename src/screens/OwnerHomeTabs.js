...
import OwnerJobPost from "./owner/ownerJobPostTabs";

class OwnerHomeTabs extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(OwnerHomeTabs);
